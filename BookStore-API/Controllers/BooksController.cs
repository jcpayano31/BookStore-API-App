...
;               }
        ...
        public async Task<IActionResult> Update(int id, [FromBody] BookUpdateDTO bookDTO) 
        {
            ...
            try
            {
                ...
                _logger.LogInfo($"{location}:  Record with id: {id} successfully update");
                return NoContent();
        ...
        public async Task<IActionResult>  Delete(int id) 
        {
            ...
            try
            {
                ...
                if (id < 1) 
                {
                    _logger.LogWarn($"{location}:  Delete failed with dad data - id: {id}");
                    return BadRequest();
                }
                ...
                _logger.LogInfo($"{location}:  Record with is: {id} successfully deleted");
                return NoContent();
